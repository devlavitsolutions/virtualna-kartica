...
@section('content')
    <div class="d-flex flex-column flex-column-fluid align-items-center mt-12 p-4">
        ...
        <div class="bg-white rounded-15 shadow-md width-540 px-5 px-sm-7 py-10 mx-auto">
            <h1 class="text-center mb-7">{{__('messages.user.set_password')}}</h1>
            <form class="form w-100" method="POST" action="{{ route('first.login.update') }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 d-flex text-start align-items-center">
                        <button type="submit" class="btn btn-primary">
                            <span class="indicator-label">{{ __('Set Password') }}</span>
                        </button>
                        <a href="{{ route('login') }}"
